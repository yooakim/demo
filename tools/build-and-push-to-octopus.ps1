...
dotnet octo pack --id Basefarm.Demo.Web --basePath .\Basefarm.Demo.Web\bin\Release\netcoreapp2.0\publish --format=zip --outFolder=.\packaged
...
dotnet octo push --server=https://octopus.skl.se  --apiKey="$env:OCTOPUS_API_KEY" --ignoreSslErrors --package=.\packaged\$packageName
